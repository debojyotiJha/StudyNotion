  ...
  return (
    <div className='flex justify-between w-11/12 max-w-[1160px] py-12 mx-auto gap-x-20 gap-y-0'>
        ...
        <div className='w-11/12 max-w-[450px]'>
            ...
            <p className='text-[1.125rem] leading-[1.62rem] mt-4'>
            ...
            <div className='flex flex-row w-full items-center gap-x-2'>
                ...
                <p className='text-richblack-700 font-meduim leading[1.375rem] mt-2'>OR</p>
                <div className='h-[1px] w-full bg-richblack-700 mt-2'></div>
            </div>

            <button className='w-full flex justify-center items-center rounded-[8px] text-richblack-100 border border-richblack-700 px-[12px] py-[8px] gap-x-6 mt-2'>
            <FcGoogle/>
